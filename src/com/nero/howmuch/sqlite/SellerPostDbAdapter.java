...
public class SellerPostDbAdapter {
	...
	private static final String TAG = "SellerPostDbAdapter";
	private DatabaseHelper mDbHelper;
	private SQLiteDatabase mDb;

	private static final String DATABASE_CREATE = "create table seller_posts (_id integer primary key, "
	...
	private static final String DATABASE_NAME = "seller";
	private static final String DATABASE_TABLE = "seller_posts";
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			...
			db.execSQL("DROP TABLE IF EXISTS seller_posts");
			onCreate(db);
		}
	}

	public SellerPostDbAdapter(Context ctx) {
		this.mCtx = ctx;
	}

	public SellerPostDbAdapter open() throws SQLException {
	...
	public int getReplyCnt(int post_id) {
		SellerReplyDbAdapter adapter = new SellerReplyDbAdapter(mCtx);
		int result = 0;
		adapter.open();
