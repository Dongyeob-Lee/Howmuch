...
public class ConsumerReplyDbAdapter {
	...
	private static final String DATABASE_CREATE = "create table consumer_reply (_id integer primary key autoincrement, reply_id integer not null, "
	...
	private static final String DATABASE_NAME = "consumerreply";
	private static final String DATABASE_TABLE = "consumer_reply";
	...
	public ConsumerReplyDbAdapter(Context ctx) {
		this.mCtx = ctx;
	}

	public ConsumerReplyDbAdapter open() throws SQLException {
